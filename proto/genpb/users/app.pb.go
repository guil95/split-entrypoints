...
var file_proto_app_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x32, 0x4d, 0x0a, 0x0c, 0x55, 0x73,
	0x65, 0x72, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d, 0x0a, 0x08, 0x47, 0x65,
...
var file_proto_app_proto_depIdxs = []int32{
	1, // 0: users.GetUsersResponse.users:type_name -> users.User
	2, // 1: users.UsersService.GetUsers:input_type -> google.protobuf.Empty
	0, // 2: users.UsersService.GetUsers:output_type -> users.GetUsersResponse
